...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-plus fa-fw"></i> &nbsp; ACTUALIZAR / EDITAR ROL
    </h3>
...
<div class="container-fluid">
    <form action="?c=Roles&a=update_rol" method="POST" class="form-neon" autocomplete="off">
        <fieldset>
            <legend><i class="fas fa-user"></i> &nbsp; Actualizar / Editar Rol</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-12">
                        ...
                        <div class="form-group">
                            <label for="name_rol_up" class="bmd-label-floating">Ingrese el Nombre para el rol o modifique el existente</label>
                            <!-- Nombre del rol -->
                            <input name="name_rol_up" value="<?php echo $rol->get_name_rol(); ?>" type="text"
                                pattern="[a-zA-Z\-]{1,40}" class="form-control" id="name_rol_up" maxlength="40">
        ...
        <p class="text-center" style="margin-top: 40px;">
            ...
            &nbsp; &nbsp;
            <button type="submit" class="btn btn-raised btn-info btn-sm"><i class="far fa-save"></i> &nbsp; ACTUALIZAR
                ROL</button>
        </p>
    </form>
</div>