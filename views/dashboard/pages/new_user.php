...
<div class="full-box page-header">
    ...
    <p class="text-justify">
        Complete el siguiente formulario para registrar un nuevo usuario.
    </p>
</div>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a href="?c=Users&a=create_user" class="active"><i class="fas fa-plus fa-fw"></i> &nbsp; CREAR USUARIO</a>
        </li>
        <li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input name="user_email" type="email" class="form-control" id="user_email" maxlength="100" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="user_rol" class="form-control" id="user_rol" required>
